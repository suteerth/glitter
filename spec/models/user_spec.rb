...
describe User do
  ...
  describe "password validations" do
    ...
    it "should require a matching password confirmation" do
      non_matching_user = User.new(@attr.merge(:password_confirmation => "bogus"))
    ...
    it "should not accept long passwords" do
      long = 'a' * 51
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email ID with no user" do
